  ...
  return (
    <section id="contact" ref={sectionRef} className="py-28 px-4 relative">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <h2 className="text-5xl md:text-7xl font-black text-white mt-4 mb-6 text-glow-neon">
          Let&apos;s Work
          <br />
          Together
        </h2>
        ...
        <div className="flex gap-4 justify-center flex-wrap mb-12">
          <a
            ...
            className="group inline-flex items-center gap-3 bg-neon text-zinc-950 hover:bg-neon-hover font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:shadow-[var(--shadow-glow-lg)] hover:scale-105"
          >
          ...
          <a
            ...
            className="group inline-flex items-center gap-3 glass text-neon hover:bg-neon/10 font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:border-neon/40"
          >
        ...
        <div className="flex gap-4 justify-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 rounded-full glass text-zinc-500 hover:text-neon hover:border-neon/30 transition-all duration-300"
            aria-label="GitHub"
          >
